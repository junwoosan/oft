...
VERSION = '22.3p0'
EP_LOCATION = 'http://52.201.146.173:' #path to the REST server
...
ep = EPRestApi(8081, EP_LOCATION, VERSION) #the first attribute is the port on which the connection request will take place (default 8080)
